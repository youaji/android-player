 ...
 * @li the @ref AVFormatContext.inputFormat "input" or @ref AVFormatContext.oformat
...
typedef struct AVFormatContext {
     ...
     * if and only if inputFormat/oformat.priv_class is not NULL.
     *
     ...
     * inputFormat/oformat.flags. In such a case, the (de)muxer will handle
